...
{
    public class OtherVenueVM : INotifyPropertyChanged
    {
        public Posts Blog
        {
            get;
        ...
        public void ReadRss()
        {
            ...
            {
                string xml = Encoding.Default.GetString(client.DownloadData("https://rinnovationlab.com/category/othervenues/feed/"));
